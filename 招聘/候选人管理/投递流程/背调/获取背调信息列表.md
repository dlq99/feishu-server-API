...
| 支持的应用类型 | custom  isv |
| 权限要求 | 获取用户 user ID <br> 更新招聘背调信息 <br> 获取招聘背调信息 |
| 权限要求 | hire:background_check_order <br> hire:background_check_order:readonly |
...
client.hire.v1.backgroundCheckOrder.list({
        params: {
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/hire/v1/background_check_orders?application_id=6985833807195212076&page_size=100&page_token=eyJvZmZzZXQiOjEsInRpbWVzdGFtcCI6MTY0MDc2NTYzMjA4OCwiaWQiOm51bGx9&update_end_time=1638848468869&update_start_time=1638848468868&user_id_type=open_id");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/hire/v1/background_check_orders?application_id=6985833807195212076&page_size=100&page_token=eyJvZmZzZXQiOjEsInRpbWVzdGFtcCI6MTY0MDc2NTYzMjA4OCwiaWQiOm51bGx9&update_end_time=1638848468869&update_start_time=1638848468868&user_id_type=open_id', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/hire/v1/background_check_orders?application_id=6985833807195212076&page_size=100&page_token=eyJvZmZzZXQiOjEsInRpbWVzdGFtcCI6MTY0MDc2NTYzMjA4OCwiaWQiOm51bGx9&update_end_time=1638848468869&update_start_time=1638848468868&user_id_type=open_id' \
...
func main() {
	...
	// 创建请求对象
	req := larkhire.NewListBackgroundCheckOrderReqBuilder().
		UserIdType(`open_id`).
	...
	// 发起请求
	resp, err := client.Hire.V1.BackgroundCheckOrder.List(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.hire.v1.background_check_order.list failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
