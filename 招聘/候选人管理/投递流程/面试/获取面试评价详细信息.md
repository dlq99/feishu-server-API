...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/hire/v1/interview_records/1618209327096?user_id_type=open_id' \
...
func main() {
	...
	// 发起请求
	resp, err := client.Hire.V1.InterviewRecord.Get(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.hire.v1.interview_record.get failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.hire.v1.interviewRecord.get({
        path: {
                interview_record_id:'1618209327096',
        },
        params: {
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/hire/v1/interview_records/1618209327096?user_id_type=open_id");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/hire/v1/interview_records/1618209327096?user_id_type=open_id', $headers, $body);
