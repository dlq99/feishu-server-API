...
| 参数名 | 类型 | 必填 | 描述 |
| ------ | ---- | ---- | ---- |
| init_source_id | string | 否 | 简历来源 ID，已弃用，请使用 resume_source_id 字段 <br> **示例**: 1  |
| resume_source_id | string | 否 | 简历来源 ID，可通过[获取简历来源列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/resume_source/list)<br>接口查询 <br> **示例**: 1  |
| folder_id_list | undefined[] | 否 | 文件夹 ID 列表，可通过[获取人才文件夹列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/talent_folder/list)接口获取 <br> **示例**: ["7025517823176132908"] <br> **数据校验规则**:<br>最大长度: 100 |
| creator_id | string | 否 | 创建人 ID，和入参 `user_id_type` 类型保持一致，默认为系统用户 ID，当创建人类型为「系统」时无需填写该字段 <br> **示例**: ou_84aad35d084aa403a838cf73ee18467  |
| creator_account_type | integer | 否 | 创建人类型 <br> **示例**: 1 <br> **可选值**:<br>- 1: 员工 <br>- 3: 系统 <br> |
| resume_attachment_id | string | 否 | 简历附件 ID，如何创建附件请参考[创建附件](/ssl:ttdoc/ukTMukTMukTM/uIDN1YjLyQTN24iM0UjN/create_attachment) <br> **示例**: 7383906146040678700  |
| basic_info | object | 是 | 基本信息 <br> **示例**:   |
| education_list | talent_combined_education_info[] | 否 | 教育经历 <br> **示例**:  <br> **数据校验规则**:<br>最大长度: 100 |
| career_list | talent_combined_career_info[] | 否 | 工作经历 <br> **示例**:  <br> **数据校验规则**:<br>最大长度: 100 |
| project_list | talent_combined_project_info[] | 否 | 项目经历 <br> **示例**:  <br> **数据校验规则**:<br>最大长度: 100 |
| works_list | talent_combined_work_info[] | 否 | 作品 <br> **示例**:  <br> **数据校验规则**:<br>最大长度: 100 |
| award_list | talent_combined_award_info[] | 否 | 获奖 <br> **示例**:  <br> **数据校验规则**:<br>最大长度: 100 |
| language_list | talent_combined_language_info[] | 否 | 语言能力 <br> **示例**:  <br> **数据校验规则**:<br>最大长度: 100 |
| sns_list | talent_combined_sns_info[] | 否 | 社交账号 <br> **示例**:  <br> **数据校验规则**:<br>最大长度: 100 |
...
| customized_data | talent_customized_data_object_value[] | 否 | 自定义模块列表<br><br><br><br>**注意**：`children` 字段为二维数组，请参考请求体示例 <br> **示例**:   |
