...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/hire/v1/talent_objects/query', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/hire/v1/talent_objects/query' \
...
func main() {
	...
	// 发起请求
	resp, err := client.Hire.V1.TalentObject.Query(context.Background())
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.hire.v1.talent_object.query failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.hire.v1.talentObject.query({
},
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/hire/v1/talent_objects/query");
client.Timeout = -1;
