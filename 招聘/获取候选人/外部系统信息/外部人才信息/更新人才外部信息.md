...
client.hire.v1.talentExternalInfo.update({
        path: {
                talent_id:'7043758982146345223',
        },
        data: {
...
$request = new Request('PUT', 'https://open.feishu.cn/open-apis/hire/v1/talents/7043758982146345223/external_info', $headers, $body);
...
```bash
curl -i -X PUT 'https://open.feishu.cn/open-apis/hire/v1/talents/7043758982146345223/external_info' \
...
func main() {
	...
	// 创建请求对象
	req := larkhire.NewUpdateTalentExternalInfoReqBuilder().
		TalentId(`7043758982146345223`).
		Body(larkhire.NewUpdateTalentExternalInfoReqBodyBuilder().
			ExternalCreateTime(`1639992265035`).
			Build()).
		Build()

	// 发起请求
	resp, err := client.Hire.V1.TalentExternalInfo.Update(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.hire.v1.talent_external_info.update failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
