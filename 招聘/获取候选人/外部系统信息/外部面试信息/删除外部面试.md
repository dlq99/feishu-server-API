...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/hire/v1/external_interviews/6960663240925956660' \
...
func main() {
	...
	// 创建请求对象
	req := larkhire.NewDeleteExternalInterviewReqBuilder().
		ExternalInterviewId(`6960663240925956660`).
		Build()

	// 发起请求
	resp, err := client.Hire.V1.ExternalInterview.Delete(context.Background(), req)
...
def main():
    ...
    # 构造请求对象
    request: DeleteExternalInterviewRequest = DeleteExternalInterviewRequest.builder() \
        .external_interview_id("6960663240925956660") \
        .build()

    # 发起请求
    response: DeleteExternalInterviewResponse = client.hire.v1.external_interview.delete(request)

    # 处理失败返回
    if not response.success():
        lark.logger.error(
            f"client.hire.v1.external_interview.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.hire.v1.externalInterview.delete({
        path: {
                external_interview_id:'6960663240925956660',
        },
},
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/hire/v1/external_interviews/6960663240925956660', $headers, $body);
