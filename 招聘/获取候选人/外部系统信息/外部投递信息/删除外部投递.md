...
| HTTP状态码 | 错误码 | 描述 | 排查建议 |
| ---------- | ------ | ---- | -------- |
| 500 | 1002001 | 系统异常<br><br> | 请根据实际报错信息定位问题或联系[技术支持](https://applink.feishu.cn/TLJpeNdW) |
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.hire.v1.external_application.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.hire.v1.externalApplication.delete({
        path: {
                external_application_id:'6960663240925956660',
        },
        params: {
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/hire/v1/external_applications/6960663240925956660?talent_id=6960663240925956660");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/hire/v1/external_applications/6960663240925956660?talent_id=6960663240925956660', $headers, $body);
...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/hire/v1/external_applications/6960663240925956660?talent_id=6960663240925956660' \
