...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.hire.v1.external_application.list failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.hire.v1.externalApplication.list({
        params: {
                talent_id:'6960663240925956660',
                page_size:10,
                page_token:'eyJvZmZzZXQiOjEwLCJ0aW1lc3RhbXAiOjE2Mjc1NTUyMjM2NzIsImlkIjpudWxsfQ==',
...
(async () => {
    for await (const item of await client.hire.v1.externalApplication.listWithIterator({
            params: {
                        talent_id:'6960663240925956660',
                        page_size:10,
            },
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/hire/v1/external_applications?page_size=10&page_token=eyJvZmZzZXQiOjEwLCJ0aW1lc3RhbXAiOjE2Mjc1NTUyMjM2NzIsImlkIjpudWxsfQ%3D%3D&talent_id=6960663240925956660");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/hire/v1/external_applications?page_size=10&page_token=eyJvZmZzZXQiOjEwLCJ0aW1lc3RhbXAiOjE2Mjc1NTUyMjM2NzIsImlkIjpudWxsfQ%3D%3D&talent_id=6960663240925956660', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/hire/v1/external_applications?page_size=10&page_token=eyJvZmZzZXQiOjEwLCJ0aW1lc3RhbXAiOjE2Mjc1NTUyMjM2NzIsImlkIjpudWxsfQ%3D%3D&talent_id=6960663240925956660' \
...
func main() {
	...
	// 创建请求对象
	req := larkhire.NewListExternalApplicationReqBuilder().
		TalentId(`6960663240925956660`).
		PageSize(10).
		PageToken(`eyJvZmZzZXQiOjEwLCJ0aW1lc3RhbXAiOjE2Mjc1NTUyMjM2NzIsImlkIjpudWxsfQ==`).
		Build()
	...
	// 发起请求
	resp, err := client.Hire.V1.ExternalApplication.List(context.Background(), req)
