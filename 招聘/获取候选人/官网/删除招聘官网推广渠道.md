...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/hire/v1/websites/1618209327096/channels/7085989097067563300', $headers, $body);
...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/hire/v1/websites/1618209327096/channels/7085989097067563300' \
...
func main() {
	...
	// 创建请求对象
	req := larkhire.NewDeleteWebsiteChannelReqBuilder().
		WebsiteId(`1618209327096`).
		ChannelId(`7085989097067563300`).
		Build()

	// 发起请求
	resp, err := client.Hire.V1.WebsiteChannel.Delete(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.hire.v1.website_channel.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.hire.v1.websiteChannel.delete({
        path: {
                website_id:'1618209327096',
                channel_id:'7085989097067563300',
        },
