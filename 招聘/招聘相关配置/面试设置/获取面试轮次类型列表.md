...
func main() {
	...
	// 创建请求对象
	req := larkhire.NewListInterviewRoundTypeReqBuilder().
		ProcessType(1).
		Build()

	// 发起请求
	resp, err := client.Hire.V1.InterviewRoundType.List(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.hire.v1.interview_round_type.list failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.hire.v1.interviewRoundType.list({
        params: {
                process_type:1,
        },
},
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/hire/v1/interview_round_types?process_type=1");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/hire/v1/interview_round_types?process_type=1', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/hire/v1/interview_round_types?process_type=1' \
