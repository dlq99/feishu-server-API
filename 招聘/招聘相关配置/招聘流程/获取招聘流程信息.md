...
| 支持的应用类型 | custom  isv |
| 权限要求 | 获取招聘流程信息 |
| 权限要求 | hire:job_process:readonly |
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/hire/v1/job_processes?page_size=10&page_token=7342029494511126794");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/hire/v1/job_processes?page_size=10&page_token=7342029494511126794', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/hire/v1/job_processes?page_size=10&page_token=7342029494511126794' \
...
func main() {
	...
	resp, err := client.Get(context.Background(),
		"/open-apis/hire/v1/job_processes?page_size=10&page_token=7342029494511126794",
		body,
...
def main():
    ...
    request: lark.BaseRequest = lark.BaseRequest.builder() \
        ...
        .uri("/open-apis/hire/v1/job_processes?page_size=10&page_token=7342029494511126794") \
...
// 复制该 Demo 后, 需要将 "YOUR_APP_ID", "YOUR_APP_SECRET" 替换为自己应用的 APP_ID, APP_SECRET.
// 以下示例代码默认根据文档示例值填充，如果存在代码问题，请在 API 调试台填上相关必要参数后再复制代码使用
public class ListJobProcessSample{
...
client.request({
    url: '/open-apis/hire/v1/job_processes?page_size=10&page_token=7342029494511126794',
    method: 'GET',
            data: null,
},
