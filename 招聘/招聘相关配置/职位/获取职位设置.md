...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/hire/v1/jobs/6960663240925956660/config?user_id_type=open_id', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/hire/v1/jobs/6960663240925956660/config?user_id_type=open_id' \
...
func main() {
	...
	// 发起请求
	resp, err := client.Hire.V1.Job.Config(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.hire.v1.job.config failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/hire/v1/jobs/6960663240925956660/config?user_id_type=open_id");
client.Timeout = -1;
