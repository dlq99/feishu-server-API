...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/hire/v1/jobs/6960663240925956555/recruiter?user_id_type=open_id");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/hire/v1/jobs/6960663240925956555/recruiter?user_id_type=open_id', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/hire/v1/jobs/6960663240925956555/recruiter?user_id_type=open_id' \
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.hire.v1.job.recruiter failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
