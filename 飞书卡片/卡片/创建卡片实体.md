...
| 参数名 | 类型 | 必填 | 描述 |
| ------ | ---- | ---- | ---- |
| type | string | 是 | 卡片数据的类型。取固定值 `card_json`。 <br> **示例**: card_json <br> **数据校验规则**:<br>最大长度: 50最小长度: 1 |
| data | string | 是 | 卡片 JSON 数据的内容。仅支持[卡片 JSON 2.0 结构](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-structure)，即你必须声明 schema 为 2.0。以下示例值未转义，使用时请注意将其转为 JSON 序列化后的字符串。 <br> **示例**: {\"schema\":\"2.0\",\"header\":{\"title\":{\"content\":\"卡片标题\",\"tag\":\"plain_text\"}},\"body\":{\"elements\":[{\"tag\":\"markdown\",\"content\":\"卡片内容\"}]}} <br> **数据校验规则**:<br>最大长度: 3000000最小长度: 1 |
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/cardkit/v1/cards");
client.Timeout = -1;
var request = new RestRequest(Method.POST);
request.AddHeader("Authorization", "Bearer t-7f1b******8e560");
request.AddHeader("Content-Type", "application/json");
var body = "{\"data\":\"{\\\"schema\\\":\\\"2.0\\\",\\\"header\\\":{\\\"title\\\":{\\\"content\\\":\\\"卡片标题\\\",\\\"tag\\\":\\\"plain_text\\\"}},\\\"body\\\":{\\\"elements\\\":[{\\\"tag\\\":\\\"markdown\\\",\\\"content\\\":\\\"卡片内容\\\"}]}}\",\"type\":\"card_json\"}";
...
$request = new Request('POST', 'https://open.feishu.cn/open-apis/cardkit/v1/cards', $headers, $body);
...
```bash
curl -i -X POST 'https://open.feishu.cn/open-apis/cardkit/v1/cards' \
