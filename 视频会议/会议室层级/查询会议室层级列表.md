...
(async () => {
    for await (const item of await client.vc.v1.roomLevel.listWithIterator({
            params: {
                        room_level_id:'omb_4ad1a2c7a2fbc5fc9570f38456931293',
                        page_size:10,
            },
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/vc/v1/room_levels?page_size=10&page_token=++&room_level_id=omb_4ad1a2c7a2fbc5fc9570f38456931293");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/vc/v1/room_levels?page_size=10&page_token=++&room_level_id=omb_4ad1a2c7a2fbc5fc9570f38456931293', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/vc/v1/room_levels?page_size=10&page_token=++&room_level_id=omb_4ad1a2c7a2fbc5fc9570f38456931293' \
...
func main() {
	...
	// 发起请求
	resp, err := client.Vc.V1.RoomLevel.List(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.vc.v1.room_level.list failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
