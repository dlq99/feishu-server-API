...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/vc/v1/meetings/6911188411932033028?user_id_type=open_id&with_meeting_ability=false&with_participants=false");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/vc/v1/meetings/6911188411932033028?user_id_type=open_id&with_meeting_ability=false&with_participants=false', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/vc/v1/meetings/6911188411932033028?user_id_type=open_id&with_meeting_ability=false&with_participants=false' \
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.vc.v1.meeting.get failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
