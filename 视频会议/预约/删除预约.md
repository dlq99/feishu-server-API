...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/vc/v1/reserves/6911188411932033028', $headers, $body);
...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/vc/v1/reserves/6911188411932033028' \
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.vc.v1.reserve.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/vc/v1/reserves/6911188411932033028");
client.Timeout = -1;
