...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/vc/v1/reports/get_daily?end_time=1608888966&start_time=1608888867&unit=0");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/vc/v1/reports/get_daily?end_time=1608888966&start_time=1608888867&unit=0', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/vc/v1/reports/get_daily?end_time=1608888966&start_time=1608888867&unit=0' \
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.vc.v1.report.get_daily failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
