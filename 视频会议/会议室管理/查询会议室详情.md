...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/vc/v1/rooms/omm_4de32cf10a4358788ff4e09e37ebbf9c?user_id_type=open_id' \
...
func main() {
	...
	// 发起请求
	resp, err := client.Vc.V1.Room.Get(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.vc.v1.room.get failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/vc/v1/rooms/omm_4de32cf10a4358788ff4e09e37ebbf9c?user_id_type=open_id");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/vc/v1/rooms/omm_4de32cf10a4358788ff4e09e37ebbf9c?user_id_type=open_id', $headers, $body);
