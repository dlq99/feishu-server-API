...
func main() {
	...
	// 发起请求
	resp, err := client.Vc.V1.MeetingRecording.Get(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.vc.v1.meeting_recording.get failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.vc.v1.meetingRecording.get({
        path: {
                meeting_id:'6911188411932033028',
        },
},
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/vc/v1/meetings/6911188411932033028/recording");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/vc/v1/meetings/6911188411932033028/recording', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/vc/v1/meetings/6911188411932033028/recording' \
