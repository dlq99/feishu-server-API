...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.mail.v1.user_mailbox.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.mail.v1.userMailbox.delete({
        path: {
                user_mailbox_id:'111111@abc.com',
        },
        params: {
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/mail/v1/user_mailboxes/111111@abc.com?transfer_mailbox=888888%40abc.com");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/mail/v1/user_mailboxes/111111@abc.com?transfer_mailbox=888888%40abc.com', $headers, $body);
...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/mail/v1/user_mailboxes/111111@abc.com?transfer_mailbox=888888%40abc.com' \
...
func main() {
	...
	// 发起请求
	resp, err := client.Mail.V1.UserMailbox.Delete(context.Background(), req)
