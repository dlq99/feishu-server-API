...
client.mail.v1.mailgroupAlias.delete({
        path: {
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/mail/v1/mailgroups/xxxxxx%20%E6%88%96%20test_group@xx.xxx/aliases/xxx@xx.xxx");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/mail/v1/mailgroups/xxxxxx%20%E6%88%96%20test_group@xx.xxx/aliases/xxx@xx.xxx', $headers, $body);
...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/mail/v1/mailgroups/xxxxxx%20%E6%88%96%20test_group@xx.xxx/aliases/xxx@xx.xxx' \
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.mail.v1.mailgroup_alias.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
