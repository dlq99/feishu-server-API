...
client.mail.v1.mailgroupPermissionMember.get({
        path: {
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/mail/v1/mailgroups/xxxxxxxxxxxxxxx%20%E6%88%96%20test_mail_group@xxx.xx/permission_members/xxxxxxxxxxxxxxx?department_id_type=open_department_id&user_id_type=open_id");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/mail/v1/mailgroups/xxxxxxxxxxxxxxx%20%E6%88%96%20test_mail_group@xxx.xx/permission_members/xxxxxxxxxxxxxxx?department_id_type=open_department_id&user_id_type=open_id', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/mail/v1/mailgroups/xxxxxxxxxxxxxxx%20%E6%88%96%20test_mail_group@xxx.xx/permission_members/xxxxxxxxxxxxxxx?department_id_type=open_department_id&user_id_type=open_id' \
...
func main() {
	...
	// 发起请求
	resp, err := client.Mail.V1.MailgroupPermissionMember.Get(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.mail.v1.mailgroup_permission_member.get failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
