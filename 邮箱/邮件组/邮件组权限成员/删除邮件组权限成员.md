...
| permission_member_id | string | The unique ID of a member in this permission group |
...
client.mail.v1.mailgroupPermissionMember.delete({
        path: {
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/mail/v1/mailgroups/xxxxxxxxxxxxxxx%20or%20test_mail_group@xxx.xx/permission_members/xxxxxxxxxxxxxxx");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/mail/v1/mailgroups/xxxxxxxxxxxxxxx%20or%20test_mail_group@xxx.xx/permission_members/xxxxxxxxxxxxxxx', $headers, $body);
...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/mail/v1/mailgroups/xxxxxxxxxxxxxxx%20or%20test_mail_group@xxx.xx/permission_members/xxxxxxxxxxxxxxx' \
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.mail.v1.mailgroup_permission_member.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
