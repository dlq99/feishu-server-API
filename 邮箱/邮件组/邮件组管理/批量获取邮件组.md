...
(async () => {
    for await (const item of await client.mail.v1.mailgroup.listWithIterator({
            params: {
                        manager_user_id:'ou_xxxxxx',
                        user_id_type:'open_id',
                        page_size:10,
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/mail/v1/mailgroups?manager_user_id=ou_xxxxxx&page_size=10&page_token=xxx&user_id_type=open_id");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/mail/v1/mailgroups?manager_user_id=ou_xxxxxx&page_size=10&page_token=xxx&user_id_type=open_id', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/mail/v1/mailgroups?manager_user_id=ou_xxxxxx&page_size=10&page_token=xxx&user_id_type=open_id' \
...
func main() {
	...
	// 发起请求
	resp, err := client.Mail.V1.Mailgroup.List(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.mail.v1.mailgroup.list failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
