...
```bash
curl -i -X PUT 'https://open.feishu.cn/open-apis/mail/v1/user_mailboxes/user@xxx.xx%20%E6%88%96%20me/rules/123123123' \
...
func main() {
	...
	// 创建请求对象
	req := larkmail.NewUpdateUserMailboxRuleReqBuilder().
	...
	// 发起请求
	resp, err := client.Mail.V1.UserMailboxRule.Update(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.mail.v1.user_mailbox_rule.update failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.mail.v1.userMailboxRule.update({
        path: {
                user_mailbox_id:'user@xxx.xx 或 me',
                rule_id:'123123123',
        },
...
$request = new Request('PUT', 'https://open.feishu.cn/open-apis/mail/v1/user_mailboxes/user@xxx.xx%20%E6%88%96%20me/rules/123123123', $headers, $body);
