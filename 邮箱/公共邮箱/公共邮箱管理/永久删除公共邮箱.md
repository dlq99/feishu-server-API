...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/mail/v1/public_mailboxes/xxxxxx@abc.com");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/mail/v1/public_mailboxes/xxxxxx@abc.com', $headers, $body);
...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/mail/v1/public_mailboxes/xxxxxx@abc.com' \
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.mail.v1.public_mailbox.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.mail.v1.publicMailbox.delete({
        path: {
                public_mailbox_id:'xxxxxx@abc.com',
        },
},
