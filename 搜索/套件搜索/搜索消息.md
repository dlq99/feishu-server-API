...
| 参数名 | 类型 | 必填 | 描述 |
| ------ | ---- | ---- | ---- |
| query | string | 是 | 搜索关键词 <br> **示例**: 测试消息  |
| from_ids | undefined[] | 否 | 消息来自user_id列表 <br> **示例**: ou_1970b39a6730a4a8e97b530d8cb14ccb  |
| chat_ids | undefined[] | 否 | 消息所在chat_id列表 <br> **示例**: oc_c063434856a818a615fd36697a9ffe09  |
| message_type | string | 否 | 消息类型(file/image/media) <br> **示例**: image <br> **可选值**:<br>- file: 文件 <br>- image: 图片 <br>- media: 视频 <br> |
| at_chatter_ids | undefined[] | 否 | at用户user_id列表 <br> **示例**: ou_1970b39a6730a4a8e97b530d8cb14ccb  |
| from_type | string | 否 | 消息来自类型(bot/user) <br> **示例**: user <br> **可选值**:<br>- bot: 机器人 <br>- user: 用户 <br> |
| chat_type | string | 否 | 会话类型(group_chat/p2p_chat) <br> **示例**: group_chat <br> **可选值**:<br>- group_chat: 群聊 <br>- p2p_chat: 单聊 <br> |
| start_time | string | 否 | 消息发送起始时间 <br> **示例**: 1609296809  |
| end_time | string | 否 | 消息发送结束时间 <br> **示例**: 1609296809  |
