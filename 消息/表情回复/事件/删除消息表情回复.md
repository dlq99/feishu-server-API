...
- 应用需要开启机器人能力。
- 应用需要配置事件订阅并订阅该事件，才能接收到事件数据。详情参见事件概述。
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	消息 ID。调用获取指定消息的内容接口，可通过 message_id 获取消息内容。
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	emoji 类型。emoji_type 值对应的表情可参见表情文案说明。
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	用户 ID。调用获取单个用户信息接口，可通过用户 ID 获取用户信息。
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	应用 ID。调用获取应用信息接口，可通过 app_id 获取应用信息。
	</md-dt-td>
</md-dt-tr>
