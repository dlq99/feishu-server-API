...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/lingo/v1/entities/enterprise_515879?outer_id=123aaa&provider=%E6%98%9F%E4%BA%91&user_id_type=open_id' \
...
func main() {
	...
	// 创建请求对象
	req := larklingo.NewGetEntityReqBuilder().
	...
	// 发起请求
	resp, err := client.Lingo.V1.Entity.Get(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.lingo.v1.entity.get failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/lingo/v1/entities/enterprise_515879?outer_id=123aaa&provider=%E6%98%9F%E4%BA%91&user_id_type=open_id");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/lingo/v1/entities/enterprise_515879?outer_id=123aaa&provider=%E6%98%9F%E4%BA%91&user_id_type=open_id', $headers, $body);
