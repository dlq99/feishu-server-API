...
func main() {
	...
	// 发起请求
	resp, err := client.Lingo.V1.Repo.List(context.Background())
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.lingo.v1.repo.list failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/lingo/v1/repos");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/lingo/v1/repos', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/lingo/v1/repos' \
