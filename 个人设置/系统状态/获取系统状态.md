...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.personal_settings.v1.system_status.list failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.personalSettings.v1.systemStatus.list({
        params: {
                page_size:50,
                page_token:'GxmvlNRvP0NdQZpa7yIqf_Lv_QuBwTQ8tXkX7w-irAghVD_TvuYd1aoJ1LQph86O-XImC4X9j9FhUPhXQDvtrQ==',
        },
...
(async () => {
    for await (const item of await client.personalSettings.v1.systemStatus.listWithIterator({
            params: {
                        page_size:50,
            },
    },
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/personal_settings/v1/system_statuses?page_size=50&page_token=GxmvlNRvP0NdQZpa7yIqf_Lv_QuBwTQ8tXkX7w-irAghVD_TvuYd1aoJ1LQph86O-XImC4X9j9FhUPhXQDvtrQ%3D%3D");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/personal_settings/v1/system_statuses?page_size=50&page_token=GxmvlNRvP0NdQZpa7yIqf_Lv_QuBwTQ8tXkX7w-irAghVD_TvuYd1aoJ1LQph86O-XImC4X9j9FhUPhXQDvtrQ%3D%3D', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/personal_settings/v1/system_statuses?page_size=50&page_token=GxmvlNRvP0NdQZpa7yIqf_Lv_QuBwTQ8tXkX7w-irAghVD_TvuYd1aoJ1LQph86O-XImC4X9j9FhUPhXQDvtrQ%3D%3D' \
