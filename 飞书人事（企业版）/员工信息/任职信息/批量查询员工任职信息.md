...
| 支持的应用类型 | custom  isv |
| 权限要求 | 读写职等信息 <br> 读写员工通道 <br> 读写任职信息 <br> 获取职等信息 <br> 获取员工的职务信息 <br> 获取薪资类型 <br> 查看员工的任职信息 <br> 读写员工的职务级别信息 <br> 获取任职公司 <br> 获取排班信息 <br> 查看任职记录的原因字段 <br> 读取任职原因 <br> 获取职务级别信息 <br> 读写员工的岗位信息 <br> 获取用户 user ID <br> 获取员工通道信息 <br> 获取员工的岗位信息 <br> 查看任职信息 |
...
| 参数名 | 类型 | 必填 | 描述 |
| ------ | ---- | ---- | ---- |
| employment_ids | undefined[] | 是 | 员工雇佣 ID 列表，可通过[【搜索员工信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/search)获取<br><br>- 应与 user_id_type 类型一致 <br> **示例**:  <br> **数据校验规则**:<br>最大长度: 100最小长度: 1 |
...
| data_date | string | 否 | 查看数据日期<br>- 默认为当天 <br> **示例**: 2020-01-01  |
