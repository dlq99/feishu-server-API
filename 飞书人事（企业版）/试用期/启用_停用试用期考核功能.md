...
| 参数名 | 类型 | 必填 | 描述 |
| ------ | ---- | ---- | ---- |
| active | boolean | 是 | 启用 / 停用状态。启用后可在试用期管理页面中可见试用期考核相关的字段。 <br> **示例**: true  |
| app_url | string | 否 | 试用期考核系统入口链接，当启用功能时该字段必填。 <br> **示例**: https://qwe111.feishuapp.bytedance.net/ae/ui/apps/176612345027111/appPages/l11bsrwss13yt?dataGrid%41pye4fsbajo21l=%7B%7D&key=ffm41o1&dataGrid%41wmv98t29vif3kj=%1B%7D  |
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/corehr/v2/probation/enable_disable_assessment");
client.Timeout = -1;
var request = new RestRequest(Method.POST);
request.AddHeader("Authorization", "Bearer t-7f1b******8e560");
request.AddHeader("Content-Type", "application/json");
var body = "{\"active\":true,\"app_url\":\"https://qwe111.feishuapp.bytedance.net/ae/ui/apps/176612345027111/appPages/l11bsrwss13yt?dataGrid%41pye4fsbajo21l=%7B%7D&key=ffm41o1&dataGrid%41wmv98t29vif3kj=%1B%7D\"}";
...
$request = new Request('POST', 'https://open.feishu.cn/open-apis/corehr/v2/probation/enable_disable_assessment', $headers, $body);
...
```bash
curl -i -X POST 'https://open.feishu.cn/open-apis/corehr/v2/probation/enable_disable_assessment' \
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.corehr.v2.probation.enable_disable_assessment failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.corehr.v2.probation.enableDisableAssessment({
        data: {
                active:true,
                app_url:'https://qwe111.feishuapp.bytedance.net/ae/ui/apps/176612345027111/appPages/l11bsrwss13yt?dataGrid%41pye4fsbajo21l=%7B%7D&key=ffm41o1&dataGrid%41wmv98t29vif3kj=%1B%7D',
        },
