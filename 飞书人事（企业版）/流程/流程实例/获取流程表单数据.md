...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/corehr/v2/processes/7341373094948242956/form_variable_data?department_id_type=people_corehr_department_id&user_id_type=people_corehr_id' \
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.corehr.v2.process_form_variable_data.get failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.corehr.v2.processFormVariableData.get({
        path: {
                process_id:'7341373094948242956',
        },
        params: {
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/corehr/v2/processes/7341373094948242956/form_variable_data?department_id_type=people_corehr_department_id&user_id_type=people_corehr_id");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/corehr/v2/processes/7341373094948242956/form_variable_data?department_id_type=people_corehr_department_id&user_id_type=people_corehr_id', $headers, $body);
