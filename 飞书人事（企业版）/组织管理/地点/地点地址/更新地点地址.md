...
| 参数名 | 类型 | 必填 | 描述 |
| ------ | ---- | ---- | ---- |
| country_region_id | string | 否 | 国家 / 地区 ID<br>- 可通过[【查询国家/地区信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-country_region/search)接口获取 <br> **示例**: 6862995757234914824  |
| region_id | string | 否 | 主要行政区 ID<br>- 可通过[【查询省份/行政区信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-country_region_subdivision/search)接口获取 <br> **示例**: 6863326264296474119  |
| city_id | string | 否 | 城市ID。<br>- 详情调用[【查询城市信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-city/search)获取 <br> **示例**: 6863333555859097096  |
| distinct_id | string | 否 | 区/县ID<br>- 详情可通过[【查询区县信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-district/search)接口获取 <br> **示例**: 6863333556291110408  |
