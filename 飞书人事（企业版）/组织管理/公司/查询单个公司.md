...
| 支持的应用类型 | custom  isv |
| 权限要求 | 更新核心人事信息 <br> 获取公司信息 <br> 获取核心人事信息 |
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/corehr/v1/companies/151515");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/corehr/v1/companies/151515', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/corehr/v1/companies/151515' \
...
func main() {
	...
	// 创建请求对象
	req := larkcorehr.NewGetCompanyReqBuilder().
		CompanyId(`151515`).
		Build()

	// 发起请求
	resp, err := client.Corehr.V1.Company.Get(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.corehr.v1.company.get failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
