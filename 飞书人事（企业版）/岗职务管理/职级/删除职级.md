...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.corehr.v1.job_level.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
public class DeleteJobLevelSample{
  ...
  public static void main(String arg[]) throws Exception {
      ...
      // 发起请求
      DeleteJobLevelResp resp = client.corehr().v1().jobLevel().delete(req);
...
client.corehr.v1.jobLevel.delete({
        path: {
                job_level_id:'5423452542',
        },
},
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/corehr/v1/job_levels/5423452542");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/corehr/v1/job_levels/5423452542', $headers, $body);
...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/corehr/v1/job_levels/5423452542' \
...
func main() {
	...
	// 创建请求对象
	req := larkcorehr.NewDeleteJobLevelReqBuilder().
		JobLevelId(`5423452542`).
		Build()

	// 发起请求
	resp, err := client.Corehr.V1.JobLevel.Delete(context.Background(), req)
