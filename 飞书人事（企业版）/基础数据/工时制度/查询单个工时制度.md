...
func main() {
	...
	// 创建请求对象
	req := larkcorehr.NewGetWorkingHoursTypeReqBuilder().
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.corehr.v1.working_hours_type.get failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.corehr.v1.workingHoursType.get({
        path: {
                working_hours_type_id:'1212',
        },
},
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/corehr/v1/working_hours_types/1212");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/corehr/v1/working_hours_types/1212', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/corehr/v1/working_hours_types/1212' \
