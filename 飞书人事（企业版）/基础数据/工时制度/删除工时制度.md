...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/corehr/v1/working_hours_types/325325254' \
...
func main() {
	...
	// 创建请求对象
	req := larkcorehr.NewDeleteWorkingHoursTypeReqBuilder().
		WorkingHoursTypeId(`325325254`).
		Build()

	// 发起请求
	resp, err := client.Corehr.V1.WorkingHoursType.Delete(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.corehr.v1.working_hours_type.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.corehr.v1.workingHoursType.delete({
        path: {
                working_hours_type_id:'325325254',
        },
},
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/corehr/v1/working_hours_types/325325254");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/corehr/v1/working_hours_types/325325254', $headers, $body);
