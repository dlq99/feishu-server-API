...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/corehr/v1/employee_types/434343434");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/corehr/v1/employee_types/434343434', $headers, $body);
...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/corehr/v1/employee_types/434343434' \
...
func main() {
	...
	// 创建请求对象
	req := larkcorehr.NewDeleteEmployeeTypeReqBuilder().
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.corehr.v1.employee_type.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.corehr.v1.employeeType.delete({
        path: {
                employee_type_id:'434343434',
        },
},
