...
| 参数名 | 类型 | 必填 | 描述 |
| ------ | ---- | ---- | ---- |
| user_setting | object | 否 | 用户设置 <br> **示例**:   |
...
- **user_setting** 类型说明:
  ...
  基本属性:
   ...
   user_id: string <br> face_key: string <br> face_key_update_time: string <br>
...
```bash
curl -i -X POST 'https://open.feishu.cn/open-apis/attendance/v1/user_settings/modify?employee_type=employee_id' \
...
func main() {
	...
	req := larkattendance.NewModifyUserSettingReqBuilder().
		...
		Body(larkattendance.NewModifyUserSettingReqBodyBuilder().
			UserSetting(larkattendance.NewUserSettingBuilder().
				UserId(`abd754f7`).
				FaceKey(`xxxxxb306842b1c189bc5212eefxxxxx`).
				FaceKeyUpdateTime(`1625681917`).
				Build()).
			Build()).
		Build()
...
def main():
    ...
    request: ModifyUserSettingRequest = ModifyUserSettingRequest.builder() \
        ...
        .request_body(ModifyUserSettingRequestBody.builder()
            .user_setting(UserSetting.builder()
                .user_id("abd754f7")
                .face_key("xxxxxb306842b1c189bc5212eefxxxxx")
                .face_key_update_time("1625681917")
                .build())
    ...
    if not response.success():
        lark.logger.error(
            f"client.attendance.v1.user_setting.modify failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
  ...
  public static void main(String arg[]) throws Exception {
      ...
      ModifyUserSettingReq req = ModifyUserSettingReq.newBuilder()
             ...
             .modifyUserSettingReqBody(ModifyUserSettingReqBody.newBuilder()
                 .userSetting(UserSetting.newBuilder()
                        .userId("abd754f7")
                        .faceKey("xxxxxb306842b1c189bc5212eefxxxxx")
                        .faceKeyUpdateTime("1625681917")
                        .build())
...
client.attendance.v1.userSetting.modify({
        params: {
                employee_type:'employee_id',
        },
        data: {
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/attendance/v1/user_settings/modify?employee_type=employee_id");
client.Timeout = -1;
var request = new RestRequest(Method.POST);
request.AddHeader("Authorization", "Bearer t-7f1b******8e560");
request.AddHeader("Content-Type", "application/json");
var body = "{\"user_setting\":{\"face_key\":\"xxxxxb306842b1c189bc5212eefxxxxx\",\"face_key_update_time\":\"1625681917\",\"user_id\":\"abd754f7\"}}";
...
$request = new Request('POST', 'https://open.feishu.cn/open-apis/attendance/v1/user_settings/modify?employee_type=employee_id', $headers, $body);
