...
| user_id | string | 是 | 当前审批人的用户 ID，ID 类型与查询参数 user_id_type 取值一致。 <br> **示例**: f7cb567e  |
| comment | string | 否 | 审批意见 <br> **示例**: OK  |
| transfer_user_id | string | 是 | 被转交人的用户 ID，ID 类型与查询参数 user_id_type 取值一致。 <br> **示例**: f4ip317q  |
...
```bash
curl -i -X POST 'https://open.feishu.cn/open-apis/approval/v4/tasks/transfer?user_id_type=open_id' \
...
func main() {
	...
	// 发起请求
	resp, err := client.Approval.V4.Task.Transfer(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.approval.v4.task.transfer failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.approval.v4.task.transfer({
        params: {
                user_id_type:'open_id',
        },
        data: {
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/approval/v4/tasks/transfer?user_id_type=open_id");
client.Timeout = -1;
var request = new RestRequest(Method.POST);
request.AddHeader("Authorization", "Bearer t-7f1b******8e560");
request.AddHeader("Content-Type", "application/json");
var body = "{\"approval_code\":\"7C468A54-8745-2245-9675-08B7C63E7A85\",\"comment\":\"OK\",\"instance_code\":\"81D31358-93AF-92D6-7425-01A5D67C4E71\",\"task_id\":\"12345\",\"transfer_user_id\":\"f4ip317q\",\"user_id\":\"f7cb567e\"}";
...
$request = new Request('POST', 'https://open.feishu.cn/open-apis/approval/v4/tasks/transfer?user_id_type=open_id', $headers, $body);
