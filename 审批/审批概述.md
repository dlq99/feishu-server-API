...
| **方法 (API)** | 权限要求 | **访问凭证** | 商店 | 自建 |
| --- | --- | --- | --- | --- |
| 同意审批任务<br><br>`POST` /open-apis/approval/v4/tasks/approve | 查看、创建、更新、删除审批应用相关信息<br> 访问审批应用<br> 同意、拒绝、退回、加签等原生审批任务操作 | `tenant_access_token` | ✓ | ✓ |
| 拒绝审批任务<br><br>`POST` /open-apis/approval/v4/tasks/reject | 查看、创建、更新、删除审批应用相关信息<br> 访问审批应用<br> 同意、拒绝、退回、加签等原生审批任务操作 | `tenant_access_token` | ✓ | ✓ |
| 转交审批任务<br><br>`POST` /open-apis/approval/v4/tasks/transfer | 查看、创建、更新、删除审批应用相关信息<br> 访问审批应用<br> 同意、拒绝、退回、加签等原生审批任务操作 | `tenant_access_token` | ✓ | ✓ |
| 退回审批任务<br><br>`POST` /open-apis/approval/v4/tasks/specified_rollback | 查看、创建、更新、删除审批应用相关信息<br> 访问审批应用<br> 同意、拒绝、退回、加签等原生审批任务操作 | `tenant_access_token` | ✓ | ✓ |
| 加签审批任务<br><br>`POST` /open-apis/approval/v4/tasks/add_sign | 访问审批应用 | `tenant_access_token` | ✓ | ✓ |
| 重新提交审批任务<br><br>`POST` /open-apis/approval/v4/tasks/resubmit | 查看、创建、更新、删除审批应用相关信息<br> 访问审批应用<br> 同意、拒绝、退回、加签等原生审批任务操作 | `tenant_access_token` | ✓ | ✓ |
...
| **方法 (API)** | 权限要求 | **访问凭证** | 商店 | 自建 |
| --- | --- | --- | --- | --- |
| 上传文件<br> <br>`POST` /approval/openapi/v2/file/upload | 访问审批应用 | `tenant_access_token` | ✓ | ✓ |
...
| **方法 (API)** | 权限要求 | **访问凭证** | 商店 | 自建 |
| --- | --- | --- | --- | --- |
| 创建评论<br><br>`POST` /open-apis/approval/v4/instances/:instance_id/comments | 查看、创建、更新、删除审批应用相关信息<br> 查看、创建、更新、删除原生审批评论相关信息 | `tenant_access_token` | ✓ | ✓ |
| 获取评论<br><br>`GET` /open-apis/approval/v4/instances/:instance_id/comments | 查看、创建、更新、删除审批应用相关信息<br> 访问审批应用<br> 查看、创建、更新、删除原生审批评论相关信息 | `tenant_access_token` | ✓ | ✓ |
| 删除评论<br><br>`DELETE` /open-apis/approval/v4/instances/:instance_id/comments/:comment_id | 查看、创建、更新、删除审批应用相关信息<br> 查看、创建、更新、删除原生审批评论相关信息 | `tenant_access_token` | ✓ | ✓ |
| 清空评论<br><br>`POST` /open-apis/approval/v4/instances/:instance_id/comments/remove | 查看、创建、更新、删除审批应用相关信息<br> 查看、创建、更新、删除原生审批评论相关信息 | `tenant_access_token` | ✓ | ✓ |
...
| **方法 (API)** | 权限要求 | **访问凭证** | 商店 | 自建 |
| --- | --- | --- | --- | --- |
| 创建三方审批定义<br><br>`POST` /open-apis/approval/v4/external_approvals | 查看、创建、更新、删除审批应用相关信息<br> 查看、创建、更新、删除三方审批定义相关信息 | `tenant_access_token` | ✓ | ✓ |
| 查看指定三方审批定义<br> <br>`GET` /open-apis/approval/v4/external_approvals/:approval_code | 查看、创建、更新、删除审批应用相关信息<br> 查看、创建、更新、删除三方审批定义相关信息 | `tenant_access_token` | ✓ | ✓ |
