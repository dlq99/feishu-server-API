...
- **file_config** 类型说明:
  ...
  基本属性:
   ...
   file_id: string <br> format: string <br> engine_type: string <br>
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/speech_to_text/v1/speech/file_recognize");
client.Timeout = -1;
var request = new RestRequest(Method.POST);
request.AddHeader("Authorization", "Bearer t-7f1b******8e560");
request.AddHeader("Content-Type", "application/json");
var body = "{\"config\":{\"engine_type\":\"16k_auto\",\"file_id\":\"qwe12dd34567890w\",\"format\":\"pcm\"},\"speech\":{\"speech\":\"PdmrfE267Cd/Z9KpmNFh71A2PSJZxSp7+8upCg==\"}}";
...
$request = new Request('POST', 'https://open.feishu.cn/open-apis/speech_to_text/v1/speech/file_recognize', $headers, $body);
...
```bash
curl -i -X POST 'https://open.feishu.cn/open-apis/speech_to_text/v1/speech/file_recognize' \
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.speech_to_text.v1.speech.file_recognize failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.speechToText.v1.speech.fileRecognize({
        data: {
                speech:{
                        speech:'PdmrfE267Cd/Z9KpmNFh71A2PSJZxSp7+8upCg==',
                        },
