...
client.admin.v1.badgeGrant.delete({
        path: {
                badge_id:'m_DjMzaK',
                grant_id:'g_uS4yux',
        },
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/admin/v1/badges/m_DjMzaK/grants/g_uS4yux");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/admin/v1/badges/m_DjMzaK/grants/g_uS4yux', $headers, $body);
...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/admin/v1/badges/m_DjMzaK/grants/g_uS4yux' \
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.admin.v1.badge_grant.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
