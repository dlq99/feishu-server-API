...
| 参数名 | 类型 | 必填 | 描述 |
| ------ | ---- | ---- | ---- |
| reminder_ids | undefined[] | 是 | 要移除的reminder的id列表 <br> **示例**:   |
...
| 403 | 1470403 | 缺少任务编辑权限。 | 检查调用身份是否有任务的编辑权限。详情见[任务功能概述](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节。 |
...
```bash
curl -i -X POST 'https://open.feishu.cn/open-apis/task/v2/tasks/d300a75f-c56a-4be9-80d1-e47653028ceb/remove_reminders?user_id_type=open_id' \
...
func main() {
	...
	req := larktask.NewRemoveRemindersTaskReqBuilder().
		...
		Body(larktask.NewRemoveRemindersTaskReqBodyBuilder().
			ReminderIds([]string{`7202449098622894100`}).
			Build()).
		Build()

	// 发起请求
	resp, err := client.Task.V2.Task.RemoveReminders(context.Background(), req)
...
def main():
    ...
    request: RemoveRemindersTaskRequest = RemoveRemindersTaskRequest.builder() \
        ...
        .request_body(RemoveRemindersTaskRequestBody.builder()
            .reminder_ids(["7202449098622894100"])
            .build()) \
        .build()
    ...
    if not response.success():
        lark.logger.error(
            f"client.task.v2.task.remove_reminders failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
public class RemoveRemindersTaskSample{
  ...
  public static void main(String arg[]) throws Exception {
      ...
      // 创建请求对象
      RemoveRemindersTaskReq req = RemoveRemindersTaskReq.newBuilder()
             .taskGuid("d300a75f-c56a-4be9-80d1-e47653028ceb")
             .userIdType("open_id")
             .removeRemindersTaskReqBody(RemoveRemindersTaskReqBody.newBuilder()
                 .reminderIds(new String[]{"7202449098622894100"})
                  .build())
             .build();

      // 发起请求
      RemoveRemindersTaskResp resp = client.task().v2().task().removeReminders(req);
...
client.task.v2.task.removeReminders({
        path: {
                task_guid:'d300a75f-c56a-4be9-80d1-e47653028ceb',
        },
        params: {
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/task/v2/tasks/d300a75f-c56a-4be9-80d1-e47653028ceb/remove_reminders?user_id_type=open_id");
client.Timeout = -1;
var request = new RestRequest(Method.POST);
request.AddHeader("Authorization", "Bearer t-7f1b******8e560");
request.AddHeader("Content-Type", "application/json");
var body = "{\"reminder_ids\":[\"7202449098622894100\"]}";
...
$request = new Request('POST', 'https://open.feishu.cn/open-apis/task/v2/tasks/d300a75f-c56a-4be9-80d1-e47653028ceb/remove_reminders?user_id_type=open_id', $headers, $body);
