...
func main() {
	...
	// 创建请求对象
	req := larkdocx.NewGetChatAnnouncementBlockChildrenReqBuilder().
	...
	// 发起请求
	resp, err := client.Docx.V1.ChatAnnouncementBlockChildren.Get(context.Background(), req)
...
def main():
    ...
    # 构造请求对象
    request: GetChatAnnouncementBlockChildrenRequest = GetChatAnnouncementBlockChildrenRequest.builder() \
    ...
    # 发起请求
    response: GetChatAnnouncementBlockChildrenResponse = client.docx.v1.chat_announcement_block_children.get(request)

    # 处理失败返回
    if not response.success():
        lark.logger.error(
            f"client.docx.v1.chat_announcement_block_children.get failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
// 复制该 Demo 后, 需要将 "YOUR_APP_ID", "YOUR_APP_SECRET" 替换为自己应用的 APP_ID, APP_SECRET.
// 以下示例代码默认根据文档示例值填充，如果存在代码问题，请在 API 调试台填上相关必要参数后再复制代码使用
public class GetChatAnnouncementBlockChildrenSample{
  ...
  public static void main(String arg[]) throws Exception {
      ...
      // 创建请求对象
      GetChatAnnouncementBlockChildrenReq req = GetChatAnnouncementBlockChildrenReq.newBuilder()
             .chatId("oc_5ad11d72b830411d72b836c20")
             .blockId("doxcnO6UW6wAw2qIcYf4hZpFIth")
             .revisionId(-1)
             .pageToken("aw7DoMKBFMOGwqHCrcO8w6jCmMOvw6ILeADCvsKNw57Di8O5XGV3LG4_w5HCqhFxSnDCrCzCn0BgZcOYUg85EMOYcEAcwqYOw4ojw5QFwofCu8KoIMO3K8Ktw4IuNMOBBHNYw4bCgCV3U1zDu8K-J8KSR8Kgw7Y0fsKZdsKvW3d9w53DnkHDrcO5bDkYwrvDisOEPcOtVFJ-I03CnsOILMOoAmLDknd6dsKqG1bClAjDuS3CvcOTwo7Dg8OrwovDsRdqIcKxw5HDohTDtXN9w5rCkWo")
      ...
      // 发起请求
      GetChatAnnouncementBlockChildrenResp resp = client.docx().v1().chatAnnouncementBlockChildren().get(req);
...
client.docx.v1.chatAnnouncementBlockChildren.get({
        path: {
                chat_id:'oc_5ad11d72b830411d72b836c20',
                block_id:'doxcnO6UW6wAw2qIcYf4hZpFIth',
        },
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/docx/v1/chats/oc_5ad11d72b830411d72b836c20/announcement/blocks/doxcnO6UW6wAw2qIcYf4hZpFIth/children?page_size=500&page_token=aw7DoMKBFMOGwqHCrcO8w6jCmMOvw6ILeADCvsKNw57Di8O5XGV3LG4_w5HCqhFxSnDCrCzCn0BgZcOYUg85EMOYcEAcwqYOw4ojw5QFwofCu8KoIMO3K8Ktw4IuNMOBBHNYw4bCgCV3U1zDu8K-J8KSR8Kgw7Y0fsKZdsKvW3d9w53DnkHDrcO5bDkYwrvDisOEPcOtVFJ-I03CnsOILMOoAmLDknd6dsKqG1bClAjDuS3CvcOTwo7Dg8OrwovDsRdqIcKxw5HDohTDtXN9w5rCkWo&revision_id=-1&user_id_type=open_id");
client.Timeout = -1;
