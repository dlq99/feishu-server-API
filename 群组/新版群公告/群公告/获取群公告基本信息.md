...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/docx/v1/chats/oc_5ad11d72b830411d72b836c20/announcement?user_id_type=open_id' \
...
func main() {
	...
	// 创建请求对象
	req := larkdocx.NewGetChatAnnouncementReqBuilder().
		ChatId(`oc_5ad11d72b830411d72b836c20`).
		UserIdType(`open_id`).
		Build()

	// 发起请求
	resp, err := client.Docx.V1.ChatAnnouncement.Get(context.Background(), req)
...
def main():
    ...
    # 发起请求
    response: GetChatAnnouncementResponse = client.docx.v1.chat_announcement.get(request)

    # 处理失败返回
    if not response.success():
        lark.logger.error(
            f"client.docx.v1.chat_announcement.get failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
public class GetChatAnnouncementSample{
  ...
  public static void main(String arg[]) throws Exception {
      ...
      // 发起请求
      GetChatAnnouncementResp resp = client.docx().v1().chatAnnouncement().get(req);
...
client.docx.v1.chatAnnouncement.get({
        path: {
                chat_id:'oc_5ad11d72b830411d72b836c20',
        },
        params: {
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/docx/v1/chats/oc_5ad11d72b830411d72b836c20/announcement?user_id_type=open_id");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/docx/v1/chats/oc_5ad11d72b830411d72b836c20/announcement?user_id_type=open_id', $headers, $body);
