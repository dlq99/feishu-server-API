...
| 支持的应用类型 | custom  isv |
| 权限要求 | 获取与更新群组信息 <br> 查看群公告信息 <br> 获取群组信息 <br> 获取用户 user ID |
| 权限要求 | im:chat <br> im:chat.announcement:read <br> im:chat:readonly |
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.im.v1.chat_announcement.get failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.im.v1.chatAnnouncement.get({
        path: {
                chat_id:'oc_5ad11d72b830411d72b836c20',
        },
        params: {
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/im/v1/chats/oc_5ad11d72b830411d72b836c20/announcement?user_id_type=open_id");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/im/v1/chats/oc_5ad11d72b830411d72b836c20/announcement?user_id_type=open_id', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/im/v1/chats/oc_5ad11d72b830411d72b836c20/announcement?user_id_type=open_id' \
