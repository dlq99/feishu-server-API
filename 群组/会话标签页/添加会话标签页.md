...
| 400 | 232046 | The number of chat tabs has reached the limit. | 自定义的会话标签页个数超过上限 20 个，无法继续添加。你可以选择[更新会话标签页](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-tab/update_tabs)或者[删除会话标签页](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-tab/delete_tabs)。 |
