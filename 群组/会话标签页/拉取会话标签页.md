...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/im/v1/chats/oc_a0553eda9014c201e6969b478895c230/chat_tabs/list_tabs' \
...
func main() {
	...
	// 发起请求
	resp, err := client.Im.V1.ChatTab.ListTabs(context.Background(), req)
