...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/acs/v1/rule_external?rule_id=7298933941867135276");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/acs/v1/rule_external?rule_id=7298933941867135276', $headers, $body);
...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/acs/v1/rule_external?rule_id=7298933941867135276' \
...
func main() {
	...
	// 创建请求对象
	req := larkacs.NewDeleteRuleExternalReqBuilder().
		RuleId(`7298933941867135276`).
		Build()

	// 发起请求
	resp, err := client.Acs.V1.RuleExternal.Delete(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.acs.v1.rule_external.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.acs.v1.ruleExternal.delete({
        params: {
                rule_id:'7298933941867135276',
        },
},
