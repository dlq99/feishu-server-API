...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.acs.v1.visitor.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/acs/v1/visitors/6939433228970082566?user_id_type=open_id");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/acs/v1/visitors/6939433228970082566?user_id_type=open_id', $headers, $body);
...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/acs/v1/visitors/6939433228970082566?user_id_type=open_id' \
