...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.corehr.v1.country_region.get failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.corehr.v1.countryRegion.get({
        path: {
                country_region_id:'67489937334909845',
        },
},
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/corehr/v1/country_regions/67489937334909845");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/corehr/v1/country_regions/67489937334909845', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/corehr/v1/country_regions/67489937334909845' \
...
func main() {
	...
	// 创建请求对象
	req := larkcorehr.NewGetCountryRegionReqBuilder().
		CountryRegionId(`67489937334909845`).
		Build()

	// 发起请求
	resp, err := client.Corehr.V1.CountryRegion.Get(context.Background(), req)
