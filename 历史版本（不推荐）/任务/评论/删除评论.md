...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/task/v1/tasks/83912691-2e43-47fc-94a4-d512e03984fa/comments/6937231762296684564' \
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.task.v1.task_comment.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.task.v1.taskComment.delete({
        path: {
                task_id:'83912691-2e43-47fc-94a4-d512e03984fa',
                comment_id:'6937231762296684564',
        },
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/task/v1/tasks/83912691-2e43-47fc-94a4-d512e03984fa/comments/6937231762296684564");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/task/v1/tasks/83912691-2e43-47fc-94a4-d512e03984fa/comments/6937231762296684564', $headers, $body);
