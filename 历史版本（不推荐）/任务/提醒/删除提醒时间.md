...
| reminder_id | string | 任务提醒时间设置的 ID（即 reminder.id） |
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/task/v1/tasks/83912691-2e43-47fc-94a4-d512e03984fa/reminders/1");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/task/v1/tasks/83912691-2e43-47fc-94a4-d512e03984fa/reminders/1', $headers, $body);
...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/task/v1/tasks/83912691-2e43-47fc-94a4-d512e03984fa/reminders/1' \
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.task.v1.task_reminder.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.task.v1.taskReminder.delete({
        path: {
                task_id:'83912691-2e43-47fc-94a4-d512e03984fa',
                reminder_id:'1',
        },
