...
| 支持的应用类型 | custom |
| 权限要求 | 创建、更新词典免审词条 <br> 查看词典词条 <br> 查看、创建、编辑、删除词典词条 |
...
func main() {
	...
	req := larkbaike.NewListClassificationReqBuilder().
		PageSize(20).
		PageToken(`408ecac018b2e3518db37275e812****bb8ad3e755fc886f322ac6c430ba`).
		Build()
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.baike.v1.classification.list failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.baike.v1.classification.list({
        params: {
                page_size:20,
                page_token:'408ecac018b2e3518db37275e812****bb8ad3e755fc886f322ac6c430ba',
        },
...
(async () => {
    for await (const item of await client.baike.v1.classification.listWithIterator({
            params: {
                        page_size:20,
            },
    },
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/baike/v1/classifications?page_size=20&page_token=408ecac018b2e3518db37275e812%2A%2A%2A%2Abb8ad3e755fc886f322ac6c430ba");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/baike/v1/classifications?page_size=20&page_token=408ecac018b2e3518db37275e812%2A%2A%2A%2Abb8ad3e755fc886f322ac6c430ba', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/baike/v1/classifications?page_size=20&page_token=408ecac018b2e3518db37275e812%2A%2A%2A%2Abb8ad3e755fc886f322ac6c430ba' \
