...
| 支持的应用类型 | custom |
| 权限要求 | 查看、创建、编辑、删除词典词条 <br> 创建、更新词典免审词条 <br> 查看词典词条 <br> 获取用户 user ID |
...
| 参数名 | 类型 | 必填 | 描述 |
| ------ | ---- | ---- | ---- |
| query | string | 否 | 搜索关键词 <br> **示例**: 词典 <br> **数据校验规则**:<br>最大长度: 100最小长度: 1 |
| classification_filter | object | 否 | 分类筛选 <br> **示例**:   |
| sources | undefined[] | 否 | 词条的创建来源，1：用户主动创建，2：批量导入，3：官方词，4：OpenAPI 创建 <br> **示例**:   |
| creators | undefined[] | 否 | 创建者 <br> **示例**: ou_30b07b63089ea46518789914dac63d36  |

**类型额外说明**:

- **classification_filter** 类型说明:

  基本属性:

   include: array <br> exclude: array <br>
...
client.baike.v1.entity.search({
        params: {
                page_size:b152fa6e6f62a291019a04c3a93f365f8ac641910506ff15ff4cad6534e087cb4ed8fa2c,
        ...
        data: {
                query:'词典',
                classification_filter:{
                        include:['7195482254012055580'],
                        exclude:['7195482254012055581'],
                        },
                sources:[1],
                creators:['ou_30b07b63089ea46518789914dac63d36'],
        },
},
...
(async () => {
    for await (const item of await client.baike.v1.entity.searchWithIterator({
            params: {
                        page_size:b152fa6e6f62a291019a04c3a93f365f8ac641910506ff15ff4cad6534e087cb4ed8fa2c,
                        user_id_type:'open_id',
            },
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/baike/v1/entities/search?page_size=b152fa6e6f62a291019a04c3a93f365f8ac641910506ff15ff4cad6534e087cb4ed8fa2c&page_token=b152fa6e6f62a291019a04c3a93f365f8ac641910506ff15ff4cad6534e087cb4ed8fa2c&user_id_type=open_id");
client.Timeout = -1;
var request = new RestRequest(Method.POST);
request.AddHeader("Authorization", "Bearer t-7f1b******8e560");
request.AddHeader("Content-Type", "application/json");
var body = "{\"classification_filter\":{\"exclude\":[\"7195482254012055581\"],\"include\":[\"7195482254012055580\"]},\"creators\":[\"ou_30b07b63089ea46518789914dac63d36\"],\"query\":\"词典\",\"sources\":[1]}";
...
$request = new Request('POST', 'https://open.feishu.cn/open-apis/baike/v1/entities/search?page_size=b152fa6e6f62a291019a04c3a93f365f8ac641910506ff15ff4cad6534e087cb4ed8fa2c&page_token=b152fa6e6f62a291019a04c3a93f365f8ac641910506ff15ff4cad6534e087cb4ed8fa2c&user_id_type=open_id', $headers, $body);
...
```bash
curl -i -X POST 'https://open.feishu.cn/open-apis/baike/v1/entities/search?page_size=b152fa6e6f62a291019a04c3a93f365f8ac641910506ff15ff4cad6534e087cb4ed8fa2c&page_token=b152fa6e6f62a291019a04c3a93f365f8ac641910506ff15ff4cad6534e087cb4ed8fa2c&user_id_type=open_id' \
...
func main() {
	...
	req := larkbaike.NewSearchEntityReqBuilder().
		PageSize(b152fa6e6f62a291019a04c3a93f365f8ac641910506ff15ff4cad6534e087cb4ed8fa2c).
		...
		Body(larkbaike.NewSearchEntityReqBodyBuilder().
			Query(`词典`).
			ClassificationFilter(larkbaike.NewClassificationFilterBuilder().
				Include([]string{`7195482254012055580`}).
				Exclude([]string{`7195482254012055581`}).
				Build()).
			Sources([]int{1}).
			Creators([]string{`ou_30b07b63089ea46518789914dac63d36`}).
			Build()).
		Build()
...
def main():
    ...
    request: SearchEntityRequest = SearchEntityRequest.builder() \
        ...
        .request_body(SearchEntityRequestBody.builder()
            .query("词典")
            .classification_filter(ClassificationFilter.builder()
                .include(["7195482254012055580"])
                .exclude(["7195482254012055581"])
                .build())
            .sources([1])
    ...
    if not response.success():
        lark.logger.error(
            f"client.baike.v1.entity.search failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
  ...
  public static void main(String arg[]) throws Exception {
      ...
      SearchEntityReq req = SearchEntityReq.newBuilder()
             ...
             .searchEntityReqBody(SearchEntityReqBody.newBuilder()
                 .query("词典")
                 .classificationFilter(ClassificationFilter.newBuilder()
                        .include(new String[]{"7195482254012055580"})
                        .exclude(new String[]{"7195482254012055581"})
                        .build())
                 .sources(new Integer[]{1})
                 .creators(new String[]{"ou_30b07b63089ea46518789914dac63d36"})
                  .build())
             .build();
