...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.vc.v1.room_config.query failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
public class QueryRoomConfigSample{
  ...
  public static void main(String arg[]) throws Exception {
      ...
      // 发起请求
      QueryRoomConfigResp resp = client.vc().v1().roomConfig().query(req);
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/vc/v1/room_configs/query?building_id=22&country_id=086&district_id=001&floor_name=4&room_id=6383786266263&scope=5");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/vc/v1/room_configs/query?building_id=22&country_id=086&district_id=001&floor_name=4&room_id=6383786266263&scope=5', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/vc/v1/room_configs/query?building_id=22&country_id=086&district_id=001&floor_name=4&room_id=6383786266263&scope=5' \
