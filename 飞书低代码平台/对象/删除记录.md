...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.apaas.v1.application_object_record.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.apaas.v1.applicationObjectRecord.delete({
        path: {
                namespace:'package_test__c',
                object_api_name:'user',
                id:'1764024447556775',
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/apaas/v1/applications/package_test__c/objects/user/records/1764024447556775', $headers, $body);
...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/apaas/v1/applications/package_test__c/objects/user/records/1764024447556775' \
...
func main() {
	...
	// 创建请求对象
	req := larkapaas.NewDeleteApplicationObjectRecordReqBuilder().
		Namespace(`package_test__c`).
		ObjectApiName(`user`).
		Id(`1764024447556775`).
		Build()
	...
	// 发起请求
	resp, err := client.Apaas.V1.ApplicationObjectRecord.Delete(context.Background(), req)
