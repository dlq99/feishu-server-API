...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/helpdesk/v1/categories/6948728206392295444' \
...
func main() {
	...
	// 发起请求
	resp, err := client.Helpdesk.V1.Category.Get(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.helpdesk.v1.category.get failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.helpdesk.v1.category.get({
        path: {
                id:'6948728206392295444',
        },
},
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/helpdesk/v1/categories/6948728206392295444', $headers, $body);
