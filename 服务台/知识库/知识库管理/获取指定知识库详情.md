...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/helpdesk/v1/faqs/6856395634652479491', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/helpdesk/v1/faqs/6856395634652479491' \
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.helpdesk.v1.faq.get failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
