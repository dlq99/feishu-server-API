...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.helpdesk.v1.agent_skill.get failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.helpdesk.v1.agentSkill.get({
        path: {
                agent_skill_id:'6941215891786825756',
        },
},
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/helpdesk/v1/agent_skills/6941215891786825756");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/helpdesk/v1/agent_skills/6941215891786825756', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/helpdesk/v1/agent_skills/6941215891786825756' \
