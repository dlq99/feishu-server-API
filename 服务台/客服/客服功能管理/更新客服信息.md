...
| 参数名 | 类型 | 必填 | 描述 |
| ------ | ---- | ---- | ---- |
| status | integer | 否 | agent status，1：在线；2：离线 <br> **示例**: 1  |
...
$request = new Request('PATCH', 'https://open.feishu.cn/open-apis/helpdesk/v1/agents/ou_14777d82ffef0f707de5a8c7ff2c5ebe', $headers, $body);
...
```bash
curl -i -X PATCH 'https://open.feishu.cn/open-apis/helpdesk/v1/agents/ou_14777d82ffef0f707de5a8c7ff2c5ebe' \
...
func main() {
	...
	// 发起请求
	resp, err := client.Helpdesk.V1.Agent.Patch(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.helpdesk.v1.agent.patch failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.helpdesk.v1.agent.patch({
        path: {
                agent_id:'ou_14777d82ffef0f707de5a8c7ff2c5ebe',
        },
        data: {
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/helpdesk/v1/agents/ou_14777d82ffef0f707de5a8c7ff2c5ebe");
client.Timeout = -1;
