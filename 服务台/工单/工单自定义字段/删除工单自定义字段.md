...
client.helpdesk.v1.ticketCustomizedField.delete({
        path: {
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/helpdesk/v1/ticket_customized_fields/6948728206392295444");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/helpdesk/v1/ticket_customized_fields/6948728206392295444', $headers, $body);
...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/helpdesk/v1/ticket_customized_fields/6948728206392295444' \
...
func main() {
	...
	// 发起请求
	resp, err := client.Helpdesk.V1.TicketCustomizedField.Delete(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.helpdesk.v1.ticket_customized_field.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
