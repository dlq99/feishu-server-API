...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/contact/v3/job_levels/mga5oa8ayjlp9rb' \
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.contact.v3.job_level.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.contact.v3.jobLevel.delete({
        path: {
                job_level_id:'mga5oa8ayjlp9rb',
        },
},
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/contact/v3/job_levels/mga5oa8ayjlp9rb', $headers, $body);
