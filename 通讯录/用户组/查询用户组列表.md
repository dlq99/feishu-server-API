...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.contact.v3.group.simplelist failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.contact.v3.group.simplelist({
        params: {
                page_size:50,
                page_token:'AQD9/Rn9eij9Pm39ED40/dk53s4Ebp882DYfFaPFbz00L4CMZJrqGdzNyc8BcZtDbwVUvRmQTvyMYicnGWrde9X56TgdBuS+JKiSIkdexPw=',
                type:1,
...
(async () => {
    for await (const item of await client.contact.v3.group.simplelistWithIterator({
            params: {
                        page_size:50,
                        type:1,
            },
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/contact/v3/group/simplelist?page_size=50&page_token=AQD9%2FRn9eij9Pm39ED40%2Fdk53s4Ebp882DYfFaPFbz00L4CMZJrqGdzNyc8BcZtDbwVUvRmQTvyMYicnGWrde9X56TgdBuS%2BJKiSIkdexPw%3D&type=1");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/contact/v3/group/simplelist?page_size=50&page_token=AQD9%2FRn9eij9Pm39ED40%2Fdk53s4Ebp882DYfFaPFbz00L4CMZJrqGdzNyc8BcZtDbwVUvRmQTvyMYicnGWrde9X56TgdBuS%2BJKiSIkdexPw%3D&type=1', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/contact/v3/group/simplelist?page_size=50&page_token=AQD9%2FRn9eij9Pm39ED40%2Fdk53s4Ebp882DYfFaPFbz00L4CMZJrqGdzNyc8BcZtDbwVUvRmQTvyMYicnGWrde9X56TgdBuS%2BJKiSIkdexPw%3D&type=1' \
