...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.contact.v3.group.member_belong failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.contact.v3.group.memberBelong({
        params: {
                member_id:'u287xj12',
                member_id_type:'open_id',
                group_type:1,
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/contact/v3/group/member_belong?group_type=1&member_id=u287xj12&member_id_type=open_id&page_size=500&page_token=AQD9%2FRn9eij9Pm39ED40%2Fdk53s4Ebp882DYfFaPFbz00L4CMZJrqGdzNyc8BcZtDbwVUvRmQTvyMYicnGWrde9X56TgdBuS%2BJKiSIkdexPw%3D");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/contact/v3/group/member_belong?group_type=1&member_id=u287xj12&member_id_type=open_id&page_size=500&page_token=AQD9%2FRn9eij9Pm39ED40%2Fdk53s4Ebp882DYfFaPFbz00L4CMZJrqGdzNyc8BcZtDbwVUvRmQTvyMYicnGWrde9X56TgdBuS%2BJKiSIkdexPw%3D', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/contact/v3/group/member_belong?group_type=1&member_id=u287xj12&member_id_type=open_id&page_size=500&page_token=AQD9%2FRn9eij9Pm39ED40%2Fdk53s4Ebp882DYfFaPFbz00L4CMZJrqGdzNyc8BcZtDbwVUvRmQTvyMYicnGWrde9X56TgdBuS%2BJKiSIkdexPw%3D' \
