...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/contact/v3/unit?page_size=50&page_token=AQD9%2FRn9eij9Pm39ED40%2Fdk53s4Ebp882DYfFaPFbz00L4CMZJrqGdzNyc8BcZtDbwVUvRmQTvyMYicnGWrde9X56TgdBuS%2BJKiSIkdexPw%3D' \
...
func main() {
	...
	// 发起请求
	resp, err := client.Contact.V3.Unit.List(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.contact.v3.unit.list failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
public class ListUnitSample{
  ...
  public static void main(String arg[]) throws Exception {
      ...
      // 发起请求
      ListUnitResp resp = client.contact().v3().unit().list(req);
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/contact/v3/unit?page_size=50&page_token=AQD9%2FRn9eij9Pm39ED40%2Fdk53s4Ebp882DYfFaPFbz00L4CMZJrqGdzNyc8BcZtDbwVUvRmQTvyMYicnGWrde9X56TgdBuS%2BJKiSIkdexPw%3D");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/contact/v3/unit?page_size=50&page_token=AQD9%2FRn9eij9Pm39ED40%2Fdk53s4Ebp882DYfFaPFbz00L4CMZJrqGdzNyc8BcZtDbwVUvRmQTvyMYicnGWrde9X56TgdBuS%2BJKiSIkdexPw%3D', $headers, $body);
