...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.contact.v3.unit.get failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/contact/v3/unit/BU121', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/contact/v3/unit/BU121' \
...
func main() {
	...
	// 发起请求
	resp, err := client.Contact.V3.Unit.Get(context.Background(), req)
