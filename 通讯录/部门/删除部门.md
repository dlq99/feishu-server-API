...
client.contact.v3.department.delete({
        path: {
                department_id:'D096',
        },
        params: {
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/contact/v3/departments/D096?department_id_type=open_department_id");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/contact/v3/departments/D096?department_id_type=open_department_id', $headers, $body);
...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/contact/v3/departments/D096?department_id_type=open_department_id' \
...
func main() {
	...
	// 发起请求
	resp, err := client.Contact.V3.Department.Delete(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.contact.v3.department.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
