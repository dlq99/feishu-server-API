...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.contact.v3.employee_type_enum.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.contact.v3.employeeTypeEnum.delete({
        path: {
                enum_id:'exGeIjow7zIqWMy+ONkFxA==',
        },
},
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/contact/v3/employee_type_enums/exGeIjow7zIqWMy+ONkFxA==', $headers, $body);
...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/contact/v3/employee_type_enums/exGeIjow7zIqWMy+ONkFxA==' \
