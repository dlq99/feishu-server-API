...
| 支持的应用类型 | custom  isv |
| 权限要求 | 获取日历、日程及忙闲信息 <br> 读取 Exchange 绑定关系 <br> 获取用户邮箱信息 <br> 获取用户 user ID |
| 权限要求 | calendar:calendar:readonly <br> calendar:exchange.bindings:read |
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/calendar/v4/exchange_bindings/ZW1haWxfYWRtaW5fZXhhbXBsZUBvdXRsb29rLmNvbSBlbWFpbF9hY2NvdW50X2V4YW1wbGVAb3V0bG9vay5jb20=?user_id_type=open_id");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/calendar/v4/exchange_bindings/ZW1haWxfYWRtaW5fZXhhbXBsZUBvdXRsb29rLmNvbSBlbWFpbF9hY2NvdW50X2V4YW1wbGVAb3V0bG9vay5jb20=?user_id_type=open_id', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/calendar/v4/exchange_bindings/ZW1haWxfYWRtaW5fZXhhbXBsZUBvdXRsb29rLmNvbSBlbWFpbF9hY2NvdW50X2V4YW1wbGVAb3V0bG9vay5jb20=?user_id_type=open_id' \
...
func main() {
	...
	// 发起请求
	resp, err := client.Calendar.V4.ExchangeBinding.Get(context.Background(), req)
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.calendar.v4.exchange_binding.get failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.calendar.v4.exchangeBinding.get({
        path: {
                exchange_binding_id:'ZW1haWxfYWRtaW5fZXhhbXBsZUBvdXRsb29rLmNvbSBlbWFpbF9hY2NvdW50X2V4YW1wbGVAb3V0bG9vay5jb20=',
        },
        params: {
