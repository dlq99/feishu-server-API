...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/bitable/v1/apps/bascnCMII2ORej2RItqpZZUNMIe/tables/tblxI2tWaxP5dG7p/forms/vewTpR1urY/fields?page_size=10&page_token=vewTpR1urY', $headers, $body);
...
```bash
curl -i -X GET 'https://open.feishu.cn/open-apis/bitable/v1/apps/bascnCMII2ORej2RItqpZZUNMIe/tables/tblxI2tWaxP5dG7p/forms/vewTpR1urY/fields?page_size=10&page_token=vewTpR1urY' \
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.bitable.v1.app_table_form_field.list failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
public class ListAppTableFormFieldSample{
  ...
  public static void main(String arg[]) throws Exception {
      ...
      // 发起请求
      ListAppTableFormFieldResp resp = client.bitable().v1().appTableFormField().list(req);
...
client.bitable.v1.appTableFormField.list({
        path: {
                app_token:'bascnCMII2ORej2RItqpZZUNMIe',
                table_id:'tblxI2tWaxP5dG7p',
                form_id:'vewTpR1urY',
...
(async () => {
    for await (const item of await client.bitable.v1.appTableFormField.listWithIterator({
            path: {
                    app_token:'bascnCMII2ORej2RItqpZZUNMIe',
                    table_id:'tblxI2tWaxP5dG7p',
                    form_id:'vewTpR1urY',
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/bitable/v1/apps/bascnCMII2ORej2RItqpZZUNMIe/tables/tblxI2tWaxP5dG7p/forms/vewTpR1urY/fields?page_size=10&page_token=vewTpR1urY");
client.Timeout = -1;
