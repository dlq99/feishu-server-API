...
| 支持的应用类型 | custom  isv |
| 权限要求 | 更新字段 <br> 查看、评论、编辑和管理多维表格 |
| 权限要求 | base:field:update <br> bitable:app |
...
| type | integer | 是 | 要更新的字段的类型。不支持更新 19 查找引用字段类型。 <br> **示例**: 1 <br> **可选值**:<br>- 1: 文本 <br>- 2: 数字 <br>- 3: 单选 <br>- 4: 多选 <br>- 5: 日期 <br>- 7: 复选框 <br>- 11: 人员 <br>- 13: 电话号码 <br>- 15: 超链接 <br>- 17: 附件 <br>- 18: 单项关联 <br>- 20: 公式（不支持设置公式表达式） <br>- 21: 双向关联 <br>- 22: 地理位置 <br>- 23: 群组 <br>- 1001: 创建时间 <br>- 1002: 最后更新时间 <br>- 1003: 创建人 <br>- 1004: 修改人 <br>- 1005: 自动编号 <br> |
