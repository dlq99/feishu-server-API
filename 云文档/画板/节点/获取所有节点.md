...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/board/v1/whiteboards/Ru8nwrWFOhEmaFbEU2VbPRsHcxb/nodes");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('GET', 'https://open.feishu.cn/open-apis/board/v1/whiteboards/Ru8nwrWFOhEmaFbEU2VbPRsHcxb/nodes', $headers, $body);
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.board.v1.whiteboard_node.list failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
