...
| 参数名 | 类型 |  描述 |
| ------ | ---- | ---- |
| document_id | string | 文档的唯一标识。对应新版文档 Token，[点击了解如何获取云文档 Token](/ssl:ttdoc/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)。 |
...
| document_revision_id | integer | 否 | 查询的文档版本，-1表示文档最新版本。若此时查询的版本为文档最新版本，则需要持有文档的阅读权限；若此时查询的版本为文档的历史版本，则需要持有文档的编辑权限。 |
...
func main() {
	...
	// 发起请求
	resp, err := client.Docx.V1.DocumentBlock.List(context.Background(), req)
