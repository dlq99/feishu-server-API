...
| 支持的应用类型 | custom  isv |
| 权限要求 | 查看、评论和导出文档 <br> 删除云文档中的评论 <br> 回复、修改、删除云文档中的评论 <br> 查看、评论、编辑和管理云空间中所有文件 <br> 查看、评论和下载云空间中所有文件 <br> 查看、评论、编辑和管理电子表格 <br> 查看、评论和导出电子表格 <br> 查看、评论、编辑和管理文档 |
| 权限要求 | docs:doc <br> docs:doc:readonly <br> docs:document.comment:delete <br> docs:document.comment:write_only <br> drive:drive <br> drive:drive:readonly <br> sheets:spreadsheet <br> sheets:spreadsheet:readonly |
...
def main():
    ...
    if not response.success():
        lark.logger.error(
            f"client.drive.v1.file_comment_reply.delete failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}, resp: \n{json.dumps(json.loads(response.raw.content), indent=4, ensure_ascii=False)}")
        return
...
client.drive.v1.fileCommentReply.delete({
        path: {
                file_token:'doxbcdl03Vsxhm7Qmnj110abcef',
                comment_id:'6916106822734578184',
                reply_id:'6916106822734594568',
...
```csharp
var client = new RestClient("https://open.feishu.cn/open-apis/drive/v1/files/doxbcdl03Vsxhm7Qmnj110abcef/comments/6916106822734578184/replies/6916106822734594568?file_type=doc");
client.Timeout = -1;
...
$body = 'null';
$request = new Request('DELETE', 'https://open.feishu.cn/open-apis/drive/v1/files/doxbcdl03Vsxhm7Qmnj110abcef/comments/6916106822734578184/replies/6916106822734594568?file_type=doc', $headers, $body);
...
```bash
curl -i -X DELETE 'https://open.feishu.cn/open-apis/drive/v1/files/doxbcdl03Vsxhm7Qmnj110abcef/comments/6916106822734578184/replies/6916106822734594568?file_type=doc' \
